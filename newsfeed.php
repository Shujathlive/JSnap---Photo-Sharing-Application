  ...
  <div class="content-wrapper" style="margin-top:30px;">
		<div class="cards-wrapper" style="width:100%;">
			<div class="cards" id="cards'.$i.'">
				...
				<div class="back" style="background-color:white; color:black;" >
				
						  <h5 style=" padding:10%;">Quote</h5>
						  <p style="text-align:left; padding:10%;">I am a very simple card. I am good at containing small bits of information.
    ...
    <i class="fa small fa-pencil left" aria-hidden="true" onclick="flip'.$i.'()" style="color:#009688;"></i>
